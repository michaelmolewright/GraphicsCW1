...
AsteroidField::AsteroidField( RNG& aRNG, std::size_t aWidth, std::size_t aHeight, float aDensity, float aInitialSpeedStddev, float aMaximumSpeed, float aInitialRotStddev, float aPadding )
...
void AsteroidField::resize( std::size_t aWidth, std::size_t aHeight )
{
